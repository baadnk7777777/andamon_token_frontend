    ...
    return (
        <div className=" h-screen font-work_sans ">
            ...
            <div className="flex justify-center mt-24 gap-8 font-bold">
                <button className=' w-52 text-orange-400 px-3 py-2 border-orange-400 border-2 rounded-xl'>MINT TOKEN</button>
                <button className='w-52 text-orange-400 px-3 py-2 border-orange-400 border-2 rounded-xl'>PAY HOTEL</button>
            </div>
